...
const Pedidos = () => {
  ...
  const filteredPedidos = useMemo(() => {
    ...
    return pedidos.filter((pedido) => {
      const timestampCreado = Number(pedido.creado);
      if (isNaN(timestampCreado)) return "Invalid Date";
      const dateCreado = new Date(timestampCreado);
      if (isNaN(dateCreado.getTime())) return "Invalid Date";
      ...
      return (
        ...
        dateCreado.toLocaleDateString().includes(searchLower) ||
