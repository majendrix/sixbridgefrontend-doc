...
const HeaderInterior = () => {
  return (
    <div className="wrap">
      <header className="col-lg-10 offset-lg-2 bg-white text-black mb-4">
        <nav
            ...
            <nav className="d-none d-xl-block">
              <ol className="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                <li className="breadcrumb-item text-sm">
                  <Link href="/catalogos">Volver</Link>
                </li>
              </ol>
            </nav>
            <ul className="navbar-nav justify-content-start">
              <li className="nav-item d-xl-none d-flex align-items-center">
                <button
                  ...
                  data-bs-target="#sidenav-main-sixbrige"
                  aria-controls="sidenav-main-sixbrige"
                >
